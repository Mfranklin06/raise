          ...
          <div className="flex flex-col justify-center text-left">
            ...
            <div>
              ...
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-light mt-2 text-muted-foreground">
                Eficiência Energética <br /> <span className="text-primary-strong font-medium">por Sistemas Embarcados</span>
              </h2>
            </div>

            <p className="mt-6 text-lg sm:text-xl text-muted-foreground max-w-xl leading-relaxed">
              Gerenciamento de sistemas de climatização e de trancas eletrônicas via IoT e Web.
            ...
            <div className="flex flex-col sm:flex-row gap-4 mt-8">
              ...
              >
                <span className="relative z-10 flex items-center gap-2">
                  Sistema de Climatização <BiChevronRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
                  {/* Mudança no nomes para fazer mais sentido. obs: faz parte da limpeza do código  */}
              ...
              >
                <BiShield className="w-4 h-4 mr-2 opacity-70" />
