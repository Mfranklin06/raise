...
function FeatureCard({ icon: Icon, title, description, delay }: FeatureCardProps) {
        return (
                <div
                        className="group relative bg-card/70 backdrop-blur-md rounded-lg p-6 
                        border border-border shadow-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-1 hover:border-primary/50"
                >
                        {/* Content */}
...
export default function AboutSection() {
        {/* foi removido, pois o componente de features já fazia exatamente a mesma coisa
  const features = [
    {
      icon: Zap,
    ...
    { talvez dê para voltar esse aqui depois. Cabe a verificaçaõ
      icon: Shield,
    ...
    },
    {
      ...
      description: "Integração com dispositivos inteligentes através de protocolos MQTT.",
    },
    {
      icon: Cpu,
      title: "IA Preditiva",
...
*/}
        return (
                ...
                >
                        ...
                        <div className="relative z-10 mx-auto max-w-7xl px-6">
                                ...
                                >
                                        ...
                                        <p
                                                className="text-lg sm:text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed text-justify"
                                        >
                                                RAISE é um projeto desenvolvido por alunos do IFRN Campus Parnamirim, focado na otimização da gestão energética
                                                e na modernização dos processos de automação institucional. O sistema visa oferecer uma interface intuitiva e
                                                eficiente para o monitoramento e controle de recursos, integrando tecnologias web modernas com sistemas embarcados.
                                        </p>
                                </div>
          ...
          */}
                                        ...
                                        >
                                                {/* removido, pois nao fazia nada demais
