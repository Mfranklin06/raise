...
import { BsMenuApp, BsX, BsDoorOpen, BsInfo, BsHouse, BsLightning } from "react-icons/bs";
...
export default function Header() {
  ...
  const navLinks = [
    { href: "/#home", label: "Início", icon: BsHouse },
    { href: "/#features", label: "Recursos", icon: BsLightning },
    { href: "/#about", label: "Sobre", icon: BsInfo },
    { href: "/salas", label: "Salas", icon: MdOutlineDashboard },
    { href: "/portas", label: "Portas", icon: BsDoorOpen },
  ];
  ...
  return (
    <>
      ...
      >
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8 h-full flex items-center justify-between">
          ...
          <div className="flex items-center gap-4 md:hidden">
            ...
            >
              {open ? <BsX className="w-6 h-6" /> : <BsMenuApp className="w-6 h-6" />}
            </button>
          </div>
        </div>
      </header>
      ...
      {/* Mobile Menu Overlay */}
      {open && (
        <div className="fixed inset-x-0 top-16 z-40 md:hidden p-4">
