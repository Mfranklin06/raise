import { db } from "@vercel/postgres"; // mudar isso aqui depois para o postgres

// vale a pena refatorar tudo isso aqui, colocando cada parte em um actions no diretorio em que está sendo utilizado
...
export interface UnidadeAC {
  ...
  codigos_raw?: string; // opcional, pode ser preenchido via join com codigos_raw
}
